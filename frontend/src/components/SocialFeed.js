...
function SocialFeed(props) {
  ...
  const opacitySearchRef1 = useRef();
  const opacitySearchRef2 = useRef();
      ...
      <div ref={windowRef} className="social-panel">
        <ul className="video-scroll-container">
                  ...
                  <div className="user-details-inset">
                    <div className="text-container">
                      <h5 className="ud-text udt-1">
                        ...
                        - Super Dope Track Super Dope Track Super
                      </h5>
                      <h6 className="ud-text udt-2">
                        User stating that this is dopeUser stating that this is
                        dopeUse
                      </h6>
          ...
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/RLQaZ8LeuqrTx0Eeat/source.gif')`,
            }}
          ></li>
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/s2fB8Mv2UYBPLC041d/source.gif')`,
            }}
          ></li>
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/2xDcfbqistol0Ox63h/source.gif')`,
            }}
          ></li>
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/13hSJauZ5CUJ0c/source.gif')`,
            }}
          ></li>
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/3o7btZxS1IFtwrgfQY/source.gif`,
            }}
          ></li>
          <li
            className="video-pane"
            style={{
              backgroundImage: `url('${gradientbg}'), url('https://media.giphy.com/media/t7QSxX3Ebs2OE9cOfG/source.gif')`,
            }}
          ></li>
        </ul>
      </div>
